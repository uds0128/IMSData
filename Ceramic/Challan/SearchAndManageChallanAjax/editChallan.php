    ...
    <script>
        ...
        $(function () {
            ...
            $("#savebtn").on('click', function(){
                ...
                var challanmetadata = {challanid: challanid, discount: discount, transportationcost: transportationcost, extracostdesc: extracostdesc, extracost: extracost, payedamount: payedamount};
