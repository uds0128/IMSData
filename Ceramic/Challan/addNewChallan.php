        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form action="../Challan/AddNewChallanAjax/pdf.php" method="POST" target="_blank" id='makepdf'> <input
                            type="hidden" name="challanid" id="challanid"></form>
                    <div class="row mt-5">
            ...
            if (!stockIdsToBePurchased.has(stockid)) {
                ...
                var trToBeAppend =
                    '<tr>' +
                        ...
                        '<td>' + obj[11] + '</td>' +
                        '<td>' + obj[12] + '</td>' +
                        '<td width="7%" ><input class="form-control purchase-qty calprice" onkeyup="validateQty(this,' + obj[11] + '); calprice();calsubtotal();" type="number" step="1" id="billingqty_' + $(this).attr("stockid") + '" >' +
        ...
        $("#confirmchallan").click(function () {
            if ($("#purchasedTable tbody").children().length) {
                ...
                if (customerId != '-1') {
                    ...
                    var custidobj = { customerId: customerId, totalamt: totalamt, discount: discount, transport: transport };
