                  ...
                  <div class="card-body">
                     <form class="" action="UpdateCustomer.php?update_form=<?php echo $update_id; ?>" method="post">
                        ...
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" name="cgst" value="<?php echo $gst;?>" class="form-control" id="cgst" pattern="\d{2}[A-Z]{5}\d{4}[A-Z]{1}[A-Z\d]{1}[Z]{1}[A-Z\d]{1}" placeholder="Enter GST Number"> 
                        </div>
...
<?php
  ...
  $cgst1=$_POST['cgst'];
    ...
    $q="UPDATE tblcustomermst SET CustomerName = '$name1',  MobileNo = '$mobile1', Email = '$email1' , Address ='$caddress1', GSTNo ='$cgst1', ModifiedDate = NOW() WHERE CustomerId = '$id1'";
