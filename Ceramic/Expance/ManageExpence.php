       ...
       <div class="row">
         <div class="col-md-12">
            <div class="card card-primary">
               ...
               <div class="card-body">
                  <form class="row g-3" id="radio-buttons" action="ManageExpence.php" method="post">
...
//                                $eid=$_POST['eid'];
                            ...
                            <td><?php echo $eamt; ?></td>
                            <td><a href="UpdateExpence.php?id=<?php echo $eid; ?>"><input type="Button" value="Update" name="" class="btn btn-primary" id="btn"></a> <a href="DeleteExpence.php?id=<?php echo $eid; ?>"><input type="Button" value="Delete" name="" class="btn btn-primary" id="btn"></a></td>                  
                        </tr>
                                              <?php } }?>
<!--                                               <?php  ?> -->
