        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form class="row g-3" id="radio-buttons" method="POST" action="NewExpence.php">
                            <div class="form-group col-md-12">
                                <div class="row mt-3">
                                    <div class="col-md-4 form-group">
                                        <Label class="form-label">Date of Expense:</Label>
                                        <input type="date" name="edate" class="form-control" id="date-input">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4 form-group">
...
function(isConfirm){
  if (isConfirm) {
    window.location.href = "NewExpence.php";
  }
}); }, 1);
            </script>';
