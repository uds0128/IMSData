        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form class="row g-3" id="radio-buttons" action="UpdateExpence.php?update_form=<?php echo $update_id; ?>" method="post">
...
setTimeout(function () { 
swal({
  title: "Expance updated Succesfully",
  text: "",
  type: "success",
...
function(isConfirm){
  if (isConfirm) {
    window.location.href = "ManageExpence.php";
  }
}); }, 1);
</script>';
