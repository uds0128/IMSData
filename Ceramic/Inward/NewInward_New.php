                           ...
                           <div class="card-body">
                              <div class="row g-3">
                                 ...
                                 <div class="form-group col-md-4">
                                    <label class="form-label">Product Name: </label>
                                    <select name="mname" id="mpname" class="form-select col-md-12">
                                       <?php
                                 $query = "SELECT category_id ,category_name FROM categories where active_status=true";
                                 $result = mysqli_query($conn, $query);
                                 ...
                                 <div class="form-group col-md-4">
                                    <label class="form-label">Product Type: </label>
                                    <select id="mtype" name="mtype" onchange="com1()" class="form-select">
                                       <option>Select</option>
                                    </select>
                                 </div>
                                 <div class="form-group col-md-4">
                                    <label class="form-label">HSN Code: </label>
                                    <input type="Text" name="mHSN" class="form-control" id='mhsn'>
                                 </div>
                                 <div class="form-group col-md-4" id="maddOther">
                                 </div>
                                 <div class="form-group col-md-4" id="maddOther2">
                                 </div>
                                 <div class="form-group col-md-4">
                                 </div>
                                 <div class="form-group col-md-4">
                                 ...
                                 <div class="form-group col-md-12" id="maddOther3">
                                 </div>
                                 <div class="form-group col-md-4">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="mbill" id="mbill" value="bill"
                                          onchange="checkRadio(this)">
                                       <label class="form-check-label" for="inlineRadio1">Billing</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                       <input class="form-check-input" type="radio" name="mbill" id="mother"
                                          value="other" onchange="checkRadio(this)">
                                       <label class="form-check-label" for="inlineRadio1">Other</label>
                                    </div>
                                 </div>
                                 <div class="form-group col-md-4">
                                 ...
                                 <div class="form-group col-md-2">
                                    <label class="form-label">CGST: </label>
                                    <input type="number" name="mcgst" class="form-control" id="mcgst">
                                    <!-- <select class="form-select" id="cgst" onchange="calp()">
                                 <option value="5">5</option>
                                 <option value="12">12</option>
                                 <option value="18">18</option>
                                 ...
                                 <div class="form-group col-md-2">
                                    <label class="form-label">SGST: </label>
                                    <input type="number" name="msgst" class="form-control" id="msgst">
                                    <!--                            <select class="form-select" id="sgst" onchange="calp()">
                                 <option value="5">5</option>
                                 <option value="12">12</option>
                                 <option value="18">18</option>
                              ...
                              <input type="text" name="qu" class="form-control" id="qu" onchange="calp()">
                                 ...
                                 <div class="form-group col-md-2">
                                    <label class="form-label">Total Price: </label>
                                    <input type="number" name="mtp" class="form-control" id="mtp" onfocus="calc()">
                                 </div>
                                 <br>
                                 <div class="col-12">
...
<script type="text/javascript">
   ...
   $(function () {
      ...
      $('#add_data').click(function () {
         ...
         if (name != "Select Product" && type != "-1" && HSN != "" && unit != "" && size != "" && grade != "" && code != "" && cgst != "" && sgst != "") {

            $('#data_table tbody:last-child').append(
               '<tr>' +
               '<td>' + '<input readonly id="type_' + x + '" name="type_' + x + '" style="border-width:0px;border:none;" size="15" type=text value="' + type + '"></td>' +
               '<td>' + '<input readonly id="com_' + x + '" name="com_' + x + '" style="border-width:0px;border:none;" size="15" type=text value="' + com + '"></td>' +
               '<td>' + '<input readonly id="color_' + x + '" name="color_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + color_type + '"></td>' +
               '<td>' + '<input readonly id="grade_' + x + '" name="grade_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + grade + '"></td>' +
               '<td>' + '<input readonly id="code_' + x + '" name="code_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + code + '"></td>' +
               '<td>' + '<input readonly id="unit_' + x + '" name="unit_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + unit + '"></td>' +
               '<td>' + '<input readonly id="size_' + x + '" name="size_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + size + '"></td>' +
               '<td>' + '<input readonly id="batch_' + x + '" name="batch_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + batchno + '"></td>' +
               '<td>' + '<input readonly id="bprice_' + x + '" name="bprice_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + bprice + '"></td>' +
               '<td>' + '<input readonly id="cgst_' + x + '" name="cgst_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + cgst + '"></td>' +
               '<td>' + '<input readonly id="sgst_' + x + '" name="sgst_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + sgst + '"></td>' +
               // '<td>' + '<input readonly id="gst_' + x + '" name="gst_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + gst + '"></td>' +
               '<td>' + '<input readonly id="disc_' + x + '" name="disc_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + disc + '"></td>' +
               '<td>' + '<input readonly id="qty_' + x + '" name="qty_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + qty + '"></td>' +
               '<td>' + '<input readonly id="thost_' + x + '" name="tcost_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + tcost + '"></td>' +
               '<td>' + '<input readonly id="tp_' + x + '" name="tp_' + x + '" style="border-width:0px;border:none;" size="7" type=text value="' + tp + '"></td>' +
               '<td><button type="button" id="edit_' + x + '" class="btn btn-link btn-sm edit">Edit</button><input type="button" class="btn btn-link btn-sm" value="Delete" onclick="SomeDeleteRowFunction(this)"></td>' +
               '</tr>'
            );
            x = x + 1;
      ...
      $(document).on('click', '.edit', function () {
         ...
         $("[name='mgst']").val(cgst1);
         $("[name='xyz']").val(num);
         $("[name='mdatep']").val(datep1);
         $("[name='mvname']").val(vname1);
      ...
      $(document).on('click', '.update', function () {
         ...
         $("#basep_" + xval).val(basep2);
         $("#disc_" + xval).val(disc2);
         $("#qty_" + xval).val(qty2);
         $("#tcost_" + xval).val(tcost2);
         $("#tp_" + xval).val(tp2);
         /*$("[name='Address1']").val(data.Address1);
         $("[name='Address2']").val(data.Address2);
         $("[name='State']").val(data.State);
