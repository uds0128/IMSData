...
<!--                             <td><?php echo $vemail; ?></td>
                            ...
                            <td><a href="UpdateQuatation.php?id=<?php echo $qid; ?>"><input type="Button" value="Update" name="" class="btn btn-primary" id="btn"></a><a href="DeleteQuatation.php?id=<?php echo $qid; ?>"><input type="Button" value="Delete" name="" class="btn btn-primary" id="btn"></a></td>                  
                        </tr>
                                              <?php } }?>
<!--                                               <?php  ?> -->
