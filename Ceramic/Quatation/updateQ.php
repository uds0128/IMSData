...
if(isset($_POST['submit'])){
    ...
    $q = "UPDATE tblqutationdetails SET Discription = '$qdis', Qty = $qqty, Rate = $qrate, Gst = $qgstd, GstAmount = $qgstamt, Amount=$qamt, ModifiedDate = NOW() WHERE QutationId=$q_id AND QutationNo=$qx";
