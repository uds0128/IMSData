          ...
          <div class="carr card-body">
            <form class="row g-3" id="radio-buttons" method="POST" action="profitloss.php">
              <div class="form-group col-md-6">
                FROM : <input type='date' name='vmno1' class='form-group col-md-3' id='vmno1'> TO : <input type='date'
                  name='vmno2' class='form-group col-md-3' id='vmno2'>
              </div>
              ...
              <div>
                ...
                <input type="button" value="Close" name="close" id="close" class="btn btn-success"
                  onclick='window.location = "../admin.php";s'>
              </div>
          </div>
        </div>
        <br>
                ...
                <tbody>
                  <?php
                    ...
                    //  echo "$query";
                        ...
                        $query2="SELECT sum(RoundOffDeade), sum(DueAmount) FROM challanmst WHERE RecStatus=1";
                        $run2=mysqli_query($con,$query2); 

                        $query3="SELECT  sum((breakageanddamage.BillingQty+breakageanddamage.OtherQty)*systable.BasePrice) FROM breakageanddamage join systable WHERE breakageanddamage.SysId=systable.SysId and breakageanddamage.RecStatus=1";
                        //echo "$query3";
                     ...
                     // echo "$query";
                        ...
                        // echo "$query1";
                          ...
                          $query2="SELECT sum(RoundOffDeade), sum(DueAmount) FROM challanmst WHERE ChallanDate Like '$start' and RecStatus=1";
                          //echo "$query2";
                          $run2=mysqli_query($con,$query2);

                          $query3="SELECT COALESCE(SUM(systable.BasePrice * (breakageanddamage.BillingQty + breakageanddamage.OtherQty)) as damage,0) FROM breakageanddamage join systable WHERE breakageanddamage.SysId=systable.SysId and breakageanddamage.ModifiedDate LIKE '$start' and  breakageanddamage.RecStatus=1";
                        //  echo "$query3";
                          $run3=mysqli_query($con,$query3);        
                      }
                      elseif ($_POST['vmno1'] AND $_POST['vmno2']) { 
                     ...
                     // echo "$query";
                          ...
                          $query2="SELECT sum(RoundOffDeade), sum(DueAmount) FROM challanmst WHERE ChallanDate BETWEEN '$start' AND '$end' AND RecStatus=1";
                         // echo "$query2";
                          $run2=mysqli_query($con,$query2);

                          $query3="SELECT  sum((breakageanddamage.BillingQty+breakageanddamage.OtherQty)*systable.BasePrice) FROM breakageanddamage join systable WHERE breakageanddamage.SysId=systable.SysId and breakageanddamage.ModifiedDate BETWEEN '$start' and '$end' and  breakageanddamage.RecStatus=1";
                          //echo "$query3";
                          $run3=mysqli_query($con,$query3);
                      }     
...
// }
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-3">
                <center>
                  <h4 id="val">Selling Profit:
                    <?php echo "$maxprofit" ?>
                    <!-- <input type="number" style="border: 0px" name="val" id="val" value="<?php echo "$maxprofit" ?>" readonly="" class="form-group"> -->
                  </h4>
                </center>
              </div>
              <div class="col-md-3">
                <center>
                  <h4 id="val7">Dade Loss:
                    <?php echo"$round" ?>
                  </h4>
                </center>
              </div>
              ...
              <center>
                ...
                <input type='button' id='closebtn' value='close' class="btn btn-primary" onclick="location.href = '../admin.php';">
